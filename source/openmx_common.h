static char Version_OpenMX[30] = "3.9.6"; /* version of OpenMX */ 
...
int ***nei_info_global;
int ***nei_info3_global;
double **dis_nei_global;
double **dis_nei3_global;
double **ang_nei_global;
int ***nei_list_ana;
int ***nei_list3_ana;
int *ang_num_global;
double *Dec_tot_global;
double **numerical_force;
double **model_force;
double *total_force;
double **force_error;
double **current_model_global;
double *energy_error;
double *fitted_energy_global;
int *ML_M2G;
int ML_Matomnum;
...
void ML_main(int iter,char file1[YOUSO10],char file2[YOUSO10]);
