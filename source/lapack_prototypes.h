...
/* Added by Hengyu Li 06.15.2022 */

void dsycon_(char *UPLO,INTEGER *N,double *A,INTEGER *LDA,INTEGER *IPIV,double *ANORM,double *RCOND,double *WORK,INTEGER *IWORK,INTEGER *INFO);
void dsytrf_(char *UPLO,INTEGER *N,double *A,INTEGER *LDA,INTEGER *IPIV,double *WORK,INTEGER *LWORK,INTEGER *INFO);
double dlansy_(char *NORM,char *UPLO,INTEGER *N,double *A, INTEGER *LDA,double *WORK);
